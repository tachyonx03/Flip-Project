...
Estimator.alt.kf.Q = 0.05;   % raised from 5e-4: faster KF -> low-lag velocity estimate so the D_z altitude damping is effective (removes the ~16s vertical limit cycle)
